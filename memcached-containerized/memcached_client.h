...
#include <dpdk.h>
static const uint16_t kMaxBatchSize = kMaxBurstSize;
#else
static const uint16_t kMaxBatchSize = 128;
#endif

#include <helpers.h>

static const size_t kClSize = 64;
static const size_t kMaxPacketSize = 1500;
static const size_t kSockTimeout = 1; // sec.
