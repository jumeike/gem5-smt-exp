...
static size_t HelperFormSetReqHeader(struct ReqHdr *hdr, uint16_t key_len,
  ...
  // printf("hdr->total_body_length[0]: %d\n", hdr->total_body_length[0]);
  // printf("hdr->total_body_length[1]: %d\n", hdr->total_body_length[1]);
  // printf("hdr->total_body_length[2]: %d\n", hdr->total_body_length[2]);
  // printf("hdr->total_body_length[3]: %d\n", hdr->total_body_length[3]);
